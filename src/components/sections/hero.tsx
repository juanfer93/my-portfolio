        ...
        <div className="container relative mx-auto flex flex-col items-center px-4 py-20 sm:px-6 lg:px-8">
          <div className="max-w-4xl">
            <div className="mb-14 flex min-h-[22rem] items-center justify-center py-12 sm:mb-16 sm:min-h-[26rem] sm:py-16" aria-label="Presentación del logotipo">
              <Logo animated className="h-auto w-[min(84vw,38rem)] sm:w-[min(64vw,42rem)]" />
            </div>
            ...
            <h1 className="font-headline text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl lg:text-7xl">
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-accent to-primary">Desarrollador Full Stack</span>
              <span className="block">& Especialista en Automatización con IA</span>
            </h1>
